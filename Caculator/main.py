...
Button(root, text="C", width=5, height=1, font=("arial",30, "bold"),bd=1, fg="#fff",bg="#36975f",command=lambda: clear()).place(x=10, y=100)
Button(root, text="Back", width=5, height=1, font=("arial",30, "bold"),bd=1, fg="#fff",bg="#2a2d36", command=lambda: delete_last_character() ).place(x=150, y=100)
Button(root, text="", width=5, height=1, font=("arial",30, "bold"),bd=1, fg="#fff",bg="#2a2d36").place(x=290, y=100)
Button(root, text="Close", width=5, height=1, font=("arial",30, "bold"),bd=1, fg="#fff",bg="#2a2d36", command=lambda: exit()).place(x=430, y=100)
...
Button(root, text="=", width=5, height=1, font=("arial",30, "bold"),bd=1, fg="#fff",bg="orange",command=lambda: caculate()).place(x=430, y=500)
